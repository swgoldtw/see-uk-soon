...
export const ui = {
  en: {
    ...
    'site.title': 'See UK Soon',
    'site.subtitle': 'UK Life Through Data',
    'site.copyright': '© 2025 see.uk.soon All Rights Reserved.',
  ...
  zh: {
    ...
    'nav.language': '語言',
    'site.title': '英國待會見',
    'site.subtitle': '數據看英國生活',
    'site.copyright': '© 2025 see.uk.soon 保留所有權利。',
