...
export const ui = {
  en: {
    ...
    'site.title': 'The Storyteller',
    'site.subtitle': 'Minimal musings on code, design, and life',
    'site.copyright': '© 2025 The Storyteller. All Rights Reserved.',
    ...
    'labels.exploreArticlesByAuthors': 'Explore articles organized by authors',
  ...
  zh: {
    ...
    'site.copyright': '© 2025 故事讲述者。保留所有权利。',
